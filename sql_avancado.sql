...
CREATE TABLE aluno (
  ...
  nome nvarchar(255) NOT NULL DEFAULT '',
...
IF OBJECT_ID('dbo.exercicio', 'U') IS NOT NULL
...
CREATE TABLE exercicio (
  ...
  resposta_oficial nvarchar(max) NOT NULL,
  PRIMARY KEY (id)
) 
...
VALUES
	(1,1,'20141125 16:16:05','PAGA_PF'),
	(2,1,'20150525 16:16:25','PAGA_PJ'),
	(3,3,'20150721 16:16:30','PAGA_PF'),
	(4,4,'20150515 16:15:35','PAGA_CHEQUE'),
	(7,1,'20150310 16:15:35','PAGA_BOLETO'),
	(8,3,'20140505 16:15:35','PAGA_PJ'),
	(9,2,'20150207 16:15:35','PAGA_PF'),
	(10,7,'20150115 16:15:35','PAGA_PJ'),
	(4,7,'20140708 16:15:35','PAGA_PJ'),
	(8,1,'20140601 16:15:35','PAGA_CHEQUE'),
	(1,4,'20141110 16:15:35','PAGA_BOLETO'),
	(2,4,'20141001 16:15:35','PAGA_PJ'),
	(3,4,'20141115 16:15:35','PAGA_PF'),
	(2,2,'20150104 00:00:00','PAGA_PJ');


IF OBJECT_ID('dbo.nota', 'U') IS NOT NULL
  DROP TABLE dbo.nota; 
...
IF OBJECT_ID('dbo.resposta', 'U') IS NOT NULL
...
IF OBJECT_ID('dbo.secao', 'U') IS NOT NULL
...
CREATE TABLE secao (
  ...
  explicacao nvarchar(max) NOT NULL,
  numero int NOT NULL,
  PRIMARY KEY (id)
) 
